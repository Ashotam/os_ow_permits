...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      // Typography defaults for `.prose`
      typography: ({ theme }: { theme: ThemeFn }) => ({
        DEFAULT: {
          css: {
            ...
            h2: { fontWeight: "800" },
            h3: { fontWeight: "700" },
            "h1, h2, h3, h4": { marginBottom: "0.75rem" },
        ...
        invert: {
          css: {
            ...
            a: { color: theme("colors.red.400"), "&:hover": { color: theme("colors.red.300") } },
